...
import { ProductImage, productImagePath } from "@/components/product-image";
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: { title: product.title, description: product.description, url: `/es/productos/${product.slug}`, images: [productImagePath(product)] },
