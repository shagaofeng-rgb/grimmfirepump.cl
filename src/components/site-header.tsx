...
export function SiteHeader() {
  ...
  return <header className="site-header"><div className="shell site-nav">
    ...
    <nav ref={desktopNavRef} className="desktop-nav" aria-label="Navegación principal">
      ...
      <Link href="/es/guias">Guías</Link><Link href="/es/blog">Blog</Link><Link href="/es/noticias">Noticias</Link><Link href="/es/empresa">Empresa</Link><Link href="/es/contacto">Contacto</Link>
    </nav>
